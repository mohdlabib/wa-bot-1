    ...
    client.on("message", async (message) => {
        ...
        if (
            ...
            if (game == "fam") {
                ...
                message.reply(
                    "this gamecode not available to add new question."
                );
            }
            ...
            if (chat.isGroup) {
                try {
                    ...
                    if (game.status) {
                        ...
                        if (
                            Object.values(game.game).indexOf("caklontong") > -1
                        ) {
                        ...
                        if (
                            Object.values(game.game).indexOf("tebakkata") > -1
                        ) {
                            const soal = games.getAnsWard(
                                chat.id.user,
                                "tebakkata"
                        ...
                        if (
                            Object.values(game.game).indexOf("tebaklirik") > -1
                        ) {
                            const soal = games.getAnsWard(
                                chat.id.user,
                                "tebaklirik"
                        ...
                        if (
                            Object.values(game.game).indexOf("tebakkalimat") >
                            -1
                        ) {
                            const soal = games.getAnsWard(
                                chat.id.user,
